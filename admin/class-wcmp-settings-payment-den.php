...
class WCMp_Settings_Payment_den {
	/**
    ...
    public function settings_page_init() {
        ...
        $settings_tab_options = array("tab" => "{$this->tab}",
            ...
            "sections" => array(
                "wcmp_payment_den_payout_settings_section" => array("title" => __('Den setting', 'wcmp-den-checkout-gateway'),
                    "fields" => array(
                        "key_id" => array(
                            'title' => __('Key ID', 'wcmp-den-checkout-gateway'),
                            'type' => 'text',
                            'id' => 'key_id',
                            'label_for' => 'key_id',
                            'name' => 'key_id',
                        ...
                        "key_secret" => array(
                            'title' => __('Key Secret', 'wcmp-den-checkout-gateway'),
                            'type' => 'text',
                            'id' => 'key_secret',
                        ...
                        "is_split" => array('title' => __('Enable Split Payment', 'wcmp-den-checkout-gateway'), 'type' => 'checkbox', 'id' => 'is_split', 'label_for' => 'is_split', 'name' => 'is_split', 'value' => 'Enable'), // Checkbox
                    ),
                )
            ),
        );
     ...
     */
    public function wcmp_payment_den_payout_settings_sanitize($input) {
        $new_input = array();
        $hasError = false;
        ...
        if (!$hasError) {
            add_settings_error(
                    ...
                    __('den Payout Settings Updated', 'wcmp-den-checkout-gateway'),
                    'updated'
            );
        }
