...
function init_ipay_payment_gateway() {
	...
	class WC_Gateway_Ipay extends WC_Payment_Gateway {
		...
		public function __construct() {
			...
			$this->id = 'ipay';
			//$this->icon = apply_filters('woocommerce_ipay_icon', plugins_url('assets/channels.png',__FILE__));
		...
		public function init_form_fields() {
			...
			$this->form_fields = array(
				...
				'description' => array(
					...
					'default' => __('Pay with Mobie Money or Card Online.', 'woocommerce'),
					'desc_tip' => true,
				),
				'instructions' => array(
		...
		public function redirect_ipay($order_id) {
			...
			$url = $ipayUrl . "?live=" . $live . "&oid=" . $oid . "&inv=" . $inv . "&ttl=" . $ttl . "&tel=" . $tel . "&eml=" . $eml . "&vid=" . $vid . "&curr=" . $curr . "&p1=" . $p1 . "&p2=" . $p2 . "&p3=" . $p3 . "&p4=" . $p4 . "&cbk=" . $cbk . "&cst=" . $cst . "&crl=" . $crl . "&mpesa=" . $mpesa ."&airtel=" . $airtel ."&equity=" . $equity ."&pesalink=" . $pesalink ."&mvisa=" . $mvisa ."&hsh=" . $hash . "&autopay=" . $autopay;
